...
<head>
	...
	<link href="${pageContext.request.contextPath}/css/cssFile.css" rel="stylesheet" />
	<!--  <link href="/css/cssFile.css" rel="stylesheet" type="text/css" />  -->
	<link href="${pageContext.request.contextPath}/css/NewFile3.css" rel="stylesheet" />
	<!-- <link href="/css/NewFile3.css" rel="stylesheet" type="text/css" /> -->
...
<script type="text/javascript">
    ...
    <h1 class="top_logo">
    <a href="/">
    	<span class="nav_w"><img src="resources/image/process404_miri.png"  alt="PROCESS 404" style="margin-top:15px";></span>
    </a>
    </h1>
